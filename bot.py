...
def send_welcome(message):
    bot.reply_to(message, 'Heya! I am a File To Link Bot created by @KevinDaGoat.Send me any file and i will shorten it (Video, Audio, Photo, Document)👇🏻')

@bot.message_handler(commands=['help'])
def send_welcome(message):
    bot.reply_to(message, 'Send me any type of a file and I will send you the shorten link of it')    
